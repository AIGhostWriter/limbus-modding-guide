...
export const navGroups: { label: string; items: [string, string][] }[] = [
  ...
  { label: 'DLL / START', items: [['DLL overview','/docs/dll'],['Build & deployment','/docs/dll/build']] },
  { label: 'DLL / BATTLE', items: [['Battle & skill plugins','/docs/dll/battle'],['GwangYeokNansa / AlphaStrike','/docs/dll/battle#gwangyeoknansa--alphastrike'],['SkillInterrupter','/docs/dll/battle#skillinterrupter'],['BattleMessage / FireField','/docs/dll/battle#battlemessage-and-firefieldforcer']] },
  { label: 'DLL / CINEMATIC', items: [['Cinematics & presentation','/docs/dll/presentation'],['BattleCinematicPlayer','/docs/dll/presentation#battlecinematicplayer'],['LyricsOverride','/docs/dll/presentation#lyricsoverride-and-visual-utilities']] },
  { label: 'DLL / MAP & STORY', items: [['Maps & stories','/docs/dll/maps'],['AnimatedMapSupport','/docs/dll/maps#animatedmapsupport'],['StoryScriptLoader','/docs/dll/maps#story-plugins']] },
  { label: 'DLL / MIRROR DUNGEON', items: [['Mirror Dungeon systems','/docs/dll/mirror-dungeon'],['MDOffline','/docs/dll/mirror-dungeon#mdoffline-scope'],['Encounter configuration','/docs/dll/mirror-dungeon#encounter-configuration']] },
